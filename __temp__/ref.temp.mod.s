...
l_f2_17:
    ...
    imull   %ebx                   
    movl    %eax, -104(%ebp)       
    movl    -104(%ebp), %eax        #  22:     mul    t8 <- t7, 54298
    movl    $54298, %ebx           
    imull   %ebx                   
    movl    %eax, -108(%ebp)       
    movl    -108(%ebp), %eax        #  23:     mul    t9 <- t8, 76350
    movl    $76350, %ebx           
    imull   %ebx                   
    movl    %eax, -112(%ebp)       
    movl    -112(%ebp), %eax        #  24:     mul    t10 <- t9, 63910
    movl    $63910, %ebx           
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    ...
    addl    $8, %esp               
    movl    %eax, -20(%ebp)        
    movl    $3192, %eax             #  28:     mul    t13 <- 3192, 35328
    movl    $35328, %ebx           
    imull   %ebx                   
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #  29:     mul    t14 <- t13, 54298
    movl    $54298, %ebx           
    imull   %ebx                   
    movl    %eax, -32(%ebp)        
    movl    -32(%ebp), %eax         #  30:     mul    t15 <- t14, 76350
    movl    $76350, %ebx           
    imull   %ebx                   
    movl    %eax, -36(%ebp)        
    movl    -36(%ebp), %eax         #  31:     mul    t16 <- t15, 63910
    movl    $63910, %ebx           
    imull   %ebx                   
    movl    %eax, -40(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #  33:     add    t17 <- t12, 18682
    movl    $18682, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -44(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -52(%ebp)        
    movl    -52(%ebp), %eax         #  38:     add    t20 <- t19, 59912
    movl    $59912, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -56(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -64(%ebp)        
    movl    -64(%ebp), %eax         #  43:     add    t23 <- t22, 16668
    movl    $16668, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -68(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -76(%ebp)        
    movl    -76(%ebp), %eax         #  48:     add    t26 <- t25, 82625
    movl    $82625, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -80(%ebp)        
    ...
    addl    %ebx, %eax             
    movl    %eax, -92(%ebp)        
    movl    12(%ebp), %eax          #  53:     add    t30 <- v1, t29
    movl    -92(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -96(%ebp)        
    movzbl  -97(%ebp), %eax         #  54:     assign @t30 <- t6
    movl    -96(%ebp), %edi        
    movb    %al, (%edi)            
