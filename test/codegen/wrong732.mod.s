...
l_f0_6_if_true:
    movl    $9620, %eax             #  13:     assign v1 <- 9620
    movl    %eax, 8(%ebp)          
    movl    $86069, %eax            #  14:     assign v1 <- 86069
    movl    %eax, 8(%ebp)          
...
l_f1_1_while_cond:
    ...
    jmp     l_f1_0                  #   2:     goto   0
l_f1_2_while_body:
    movl    $45380, %eax            #   4:     mul    t2 <- 45380, 3618
    movl    $3618, %ebx            
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   5:     div    t3 <- t2, 88973
    movl    $88973, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   6:     div    t4 <- t3, 50361
    movl    $50361, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   7:     assign v1 <- t4
    movl    %eax, -36(%ebp)        
...
l_f2_3_while_cond:
    ...
    movb    %al, -15(%ebp)         
    movzbl  -14(%ebp), %eax         #   5:     if     t3 = t4 goto 4_while_body
    movzbl  -15(%ebp), %ebx        
    cmpl    %ebx, %eax             
...
l_test_3:
    ...
    movb    %al, -14(%ebp)         
    movl    $83164, %eax            #  10:     assign v1 <- 83164
    movl    %eax, v1               
