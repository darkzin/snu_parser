...
f2:
    ...
    # function body
    movl    $80269, %eax            #   0:     mul    t1 <- 80269, 81242
    movl    $81242, %ebx           
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     add    t2 <- t1, 7160
    movl    $7160, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     add    t3 <- t2, 51728
    movl    $51728, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   3:     add    t4 <- t3, 69607
    movl    $69607, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
...
l_test_12_while_cond:
    jmp     l_test_12_while_cond    #   7:     goto   12_while_cond
