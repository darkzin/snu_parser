...
f1:
    ...
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 6 of <array 52 of <array 82 of <array 66 of <array 31 of <char>>>>>>> %ebp+16 ]
    ...
    # function body
    movl    $39405, %eax            #   0:     mul    t2 <- 39405, 66867
    movl    $66867, %ebx           
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    ...
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   3:     sub    t4 <- t3, 99279
    movl    $99279, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   4:     add    t5 <- t4, 42373
    movl    $42373, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   5:     sub    t6 <- t5, 92866
    movl    $92866, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
...
f2:
    ...
    #      8(%ebp)   1  [ %v0       <bool> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 62 of <array 56 of <array 34 of <array 65 of <array 79 of <bool>>>>>>> %ebp+12 ]
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 92 of <array 9 of <array 87 of <array 37 of <array 98 of <bool>>>>>>> %ebp+16 ]
    #     20(%ebp)   4  [ %v3       <ptr(4) to <array 66 of <array 88 of <array 82 of <array 69 of <array 59 of <bool>>>>>>> %ebp+20 ]
