...
f0:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 8 of <array 1 of <array 10 of <array 6 of <array 6 of <bool>>>>>>> %ebp+8 ]
...
l_f0_1_if_true:
    ...
    addl    $8, %esp               
    movl    %eax, -92(%ebp)        
    movl    $41493, %eax            #   9:     mul    t4 <- 41493, t3
    movl    -92(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -124(%ebp)       
    movl    -124(%ebp), %eax        #  10:     add    t5 <- t4, 65097
    movl    $65097, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -128(%ebp)       
    ...
    imull   %ebx                   
    movl    %eax, -136(%ebp)       
    movl    -136(%ebp), %eax        #  15:     add    t8 <- t7, 4642
    movl    $4642, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -140(%ebp)       
    ...
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #  20:     add    t11 <- t10, 84743
    movl    $84743, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #  25:     add    t14 <- t13, 65338
    movl    $65338, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
...
l_f0_7_while_cond:
    ...
    jmp     l_f0_7_while_cond       #  34:     goto   7_while_cond
l_f0_6:
...
l_f0_13:
    ...
    pushl   %eax                   
    call    DIM                     #  51:     call   t21 <- DIM
    addl    $8, %esp               
    movl    %eax, -56(%ebp)        
    movl    $5453, %eax             #  52:     mul    t22 <- 5453, t21
    movl    -56(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -60(%ebp)        
    movl    -60(%ebp), %eax         #  53:     add    t23 <- t22, 45303
    movl    $45303, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -64(%ebp)        
    ...
    addl    $8, %esp               
    movl    %eax, -68(%ebp)        
    movl    -64(%ebp), %eax         #  57:     mul    t25 <- t23, t24
    movl    -68(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -72(%ebp)        
    movl    -72(%ebp), %eax         #  58:     add    t26 <- t25, 65904
    movl    $65904, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -76(%ebp)        
    ...
    addl    $8, %esp               
    movl    %eax, -80(%ebp)        
    movl    -76(%ebp), %eax         #  62:     mul    t28 <- t26, t27
    movl    -80(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -84(%ebp)        
    movl    -84(%ebp), %eax         #  63:     add    t29 <- t28, 27065
    movl    $27065, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -88(%ebp)        
    ...
    addl    $8, %esp               
    movl    %eax, -96(%ebp)        
    movl    -88(%ebp), %eax         #  67:     mul    t31 <- t29, t30
    movl    -96(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -100(%ebp)       
    movl    -100(%ebp), %eax        #  68:     add    t32 <- t31, 84081
    movl    $84081, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -104(%ebp)       
    movl    -104(%ebp), %eax        #  69:     mul    t33 <- t32, 1
    movl    $1, %ebx               
    imull   %ebx                   
    movl    %eax, -108(%ebp)       
    movl    8(%ebp), %eax           #  70:     param  0 <- v0
    pushl   %eax                   
    call    DOFS                    #  71:     call   t34 <- DOFS
    addl    $4, %esp               
    movl    %eax, -112(%ebp)       
    movl    -108(%ebp), %eax        #  72:     add    t35 <- t33, t34
    movl    -112(%ebp), %ebx       
    addl    %ebx, %eax             
    movl    %eax, -116(%ebp)       
    movl    8(%ebp), %eax           #  73:     add    t36 <- v0, t35
    movl    -116(%ebp), %ebx       
    addl    %ebx, %eax             
    movl    %eax, -120(%ebp)       
    movzbl  -51(%ebp), %eax         #  74:     assign @t36 <- t20
    movl    -120(%ebp), %edi       
    movb    %al, (%edi)            
...
l_f1_0:
    ...
    movb    %al, -14(%ebp)         
    movl    $50530, %eax            #   8:     if     50530 >= 88363 goto 6_if_true
    movl    $88363, %ebx           
    cmpl    %ebx, %eax             
    jge     l_f1_6_if_true         
...
f2:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 8 of <array 10 of <array 5 of <array 6 of <array 2 of <bool>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <int> %ebp+12 ]
    ...
    # function body
    movl    $21696, %eax            #   0:     sub    t2 <- 21696, 94564
    movl    $94564, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     add    t3 <- t2, 98515
    movl    $98515, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    ...
    movb    %al, -21(%ebp)         
    movl    $22580, %eax            #   4:     div    t5 <- 22580, 19460
    movl    $19460, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   5:     return t5
    jmp     l_f2_exit              
