...
f0:
    ...
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 4 of <array 1 of <array 7 of <array 5 of <array 2 of <int>>>>>>> %ebp+16 ]
    ...
    movb    %al, -13(%ebp)         
l_f0_2_while_cond:
    movl    $40081, %eax            #   2:     add    t4 <- 40081, 9736
    movl    $9736, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    $38700, %eax            #   3:     if     38700 >= t4 goto 3_while_body
    movl    -20(%ebp), %ebx        
    cmpl    %ebx, %eax             
...
f1:
    # stack offsets:
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 10 of <array 2 of <array 8 of <array 1 of <array 6 of <int>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 4 of <array 1 of <array 1 of <array 6 of <array 3 of <char>>>>>>> %ebp+12 ]
...
f2:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 4 of <array 1 of <array 1 of <array 2 of <array 7 of <bool>>>>>>> %ebp+12 ]
...
main:
    ...
    # function body
    movl    $35898, %eax            #   0:     mul    t0 <- 35898, 68000
    movl    $68000, %ebx           
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     mul    t1 <- t0, 10490
    movl    $10490, %ebx           
    imull   %ebx                   
    movl    %eax, -20(%ebp)        
    ...
    movb    %al, -21(%ebp)         
    movzbl  -21(%ebp), %eax         #   5:     if     t2 = 1 goto 3_if_true
    movl    $1, %ebx               
    cmpl    %ebx, %eax             
    je      l_test_3_if_true       
