...
f0:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 98 of <array 99 of <array 10 of <array 16 of <array 37 of <bool>>>>>>> %ebp+8 ]
...
l_f0_1_while_cond:
    ...
    movb    %al, -13(%ebp)         
    movzbl  -13(%ebp), %eax         #   2:     if     t4 > 100 goto 2_while_body
    movl    $100, %ebx             
    cmpl    %ebx, %eax             
    jg      l_f0_2_while_body      
    jmp     l_f0_0                  #   3:     goto   0
l_f0_2_while_body:
    movl    $90897, %eax            #   5:     return 90897
    jmp     l_f0_exit              
    jmp     l_f0_1_while_cond       #   6:     goto   1_while_cond
l_f0_0:
    call    dummyCHARfunc           #   8:     call   t5 <- dummyCHARfunc
    movb    %al, -14(%ebp)         
    movl    $18015, %eax            #   9:     sub    t6 <- 18015, 37374
    movl    $37374, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #  10:     sub    t7 <- t6, 24690
    movl    $24690, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #  11:     sub    t8 <- t7, 32995
    movl    $32995, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #  12:     assign v2 <- t8
    movl    %eax, 16(%ebp)         
...
f1:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 24 of <array 52 of <array 76 of <array 80 of <array 29 of <char>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 78 of <array 45 of <array 66 of <array 46 of <array 94 of <int>>>>>>> %ebp+12 ]
    #     16(%ebp)   4  [ %v2       <int> %ebp+16 ]
    #     20(%ebp)   4  [ %v3       <ptr(4) to <array 25 of <array 65 of <array 5 of <array 8 of <array 99 of <bool>>>>>>> %ebp+20 ]
...
l_f1_0:
    ...
    movb    %al, -13(%ebp)         
    movl    $98, %eax               #   7:     if     98 = t4 goto 12
    movzbl  -13(%ebp), %ebx        
    cmpl    %ebx, %eax             
    je      l_f1_12                
...
l_f1_18:
    ...
    movb    %al, -15(%ebp)         
l_f1_19:
    movzbl  -15(%ebp), %eax         #  24:     return t6
    jmp     l_f1_exit              
...
f2:
    # stack offsets:
    #    -13(%ebp)   1  [ $t4       <char> %ebp-13 ]
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 56 of <array 92 of <array 21 of <array 21 of <array 98 of <int>>>>>>> %ebp+8 ]
...
main:
    ...
    addl    $4, %esp               
    jmp     l_test_exit            
    movl    $62205, %eax            #   4:     if     62205 >= 91811 goto 3
    movl    $91811, %ebx           
    cmpl    %ebx, %eax             
    jge     l_test_3               
