...
f0:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 35 of <array 54 of <array 83 of <array 37 of <array 7 of <bool>>>>>>> %ebp+12 ]
...
f1:
    # stack offsets:
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 54 of <array 25 of <array 28 of <array 67 of <array 26 of <char>>>>>>> %ebp+8 ]
...
l_f1_3_if_false:
l_f1_1:
    movl    $77246, %eax            #   5:     assign v1 <- 77246
    movl    %eax, -16(%ebp)        
...
f2:
    ...
    movb    %al, 12(%ebp)          
l_f2_3_while_cond:
    movl    $98, %eax               #   4:     if     98 = 98 goto 4_while_body
    movl    $98, %ebx              
    cmpl    %ebx, %eax             
...
main:
    ...
    # function body
l_test_1_while_cond:
    movl    $38789, %eax            #   1:     sub    t0 <- 38789, 56015
    movl    $56015, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   2:     if     t0 < 81721 goto 2_while_body
    movl    $81721, %ebx           
    cmpl    %ebx, %eax             
...
l_test_6:
    ...
    movb    %al, -17(%ebp)         
l_test_8:
    movzbl  -17(%ebp), %eax         #  14:     assign v0 <- t1
    movb    %al, v0                
