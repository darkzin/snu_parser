...
f0:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 52 of <array 1 of <array 63 of <array 61 of <array 2 of <bool>>>>>>> %ebp+12 ]
...
l_f0_12:
    movl    $100, %eax              #  15:     if     100 >= 98 goto 16
    movl    $98, %ebx              
    cmpl    %ebx, %eax             
    jge     l_f0_16                
...
l_f0_18:
    ...
    addl    $8, %esp               
    movl    %eax, -68(%ebp)        
    movl    $6171, %eax             #  26:     mul    t5 <- 6171, t4
    movl    -68(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -72(%ebp)        
    movl    -72(%ebp), %eax         #  27:     add    t6 <- t5, 77856
    movl    $77856, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -76(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -84(%ebp)        
    movl    -84(%ebp), %eax         #  32:     add    t9 <- t8, 58173
    movl    $58173, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -88(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #  37:     add    t12 <- t11, 95858
    movl    $95858, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -32(%ebp)        
    movl    -32(%ebp), %eax         #  42:     add    t15 <- t14, 77385
    movl    $77385, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -36(%ebp)        
    movl    -36(%ebp), %eax         #  43:     mul    t16 <- t15, 1
    movl    $1, %ebx               
    imull   %ebx                   
    movl    %eax, -40(%ebp)        
    ...
    addl    %ebx, %eax             
    movl    %eax, -52(%ebp)        
    movzbl  -61(%ebp), %eax         #  48:     assign @t19 <- t3
    movl    -52(%ebp), %edi        
    movb    %al, (%edi)            
l_f0_21_while_cond:
    jmp     l_f0_21_while_cond      #  50:     goto   21_while_cond
    movl    $60078, %eax            #  51:     assign v2 <- 60078
    movl    %eax, 16(%ebp)         
    jmp     l_f0_9_while_cond       #  52:     goto   9_while_cond
    jmp     l_f0_1                  #  53:     goto   1
l_f0_3_if_false:
l_f0_1:
    call    dummyINTfunc            #  56:     call   t20 <- dummyINTfunc
    movl    %eax, -60(%ebp)        
...
f1:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 89 of <array 51 of <array 83 of <array 32 of <array 3 of <bool>>>>>>> %ebp+12 ]
    ...
    call    dummyCHARfunc           #   0:     call   t2 <- dummyCHARfunc
    movb    %al, -13(%ebp)         
    movzbl  -13(%ebp), %eax         #   1:     if     t2 >= 99 goto 1
    movl    $99, %ebx              
    cmpl    %ebx, %eax             
    jge     l_f1_1                 
    jmp     l_f1_2                  #   2:     goto   2
...
f2:
    ...
    movl    %eax, -16(%ebp)        
    movl    $61733, %eax            #   1:     div    t3 <- 61733, 46906
    movl    $46906, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -20(%ebp)        
...
main:
    ...
    movb    %al, -14(%ebp)         
    movzbl  -14(%ebp), %eax         #   3:     if     t1 = 1 goto 2_if_true
    movl    $1, %ebx               
    cmpl    %ebx, %eax             
    je      l_test_2_if_true       
...
l_test_3_if_false:
l_test_1:
    jmp     l_test_8_if_true        #  13:     goto   8_if_true
