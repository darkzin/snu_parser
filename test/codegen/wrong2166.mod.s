...
f0:
    ...
    jmp     l_f0_exit              
    movl    $62303, %eax            #   2:     sub    t4 <- 62303, 91871
    movl    $91871, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   3:     sub    t5 <- t4, 17593
    movl    $17593, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    $16154, %eax            #   4:     if     16154 > t5 goto 2_if_true
    movl    -24(%ebp), %ebx        
    cmpl    %ebx, %eax             
    jg      l_f0_2_if_true         
...
l_f0_1:
    ...
    movb    %al, -25(%ebp)         
    movzbl  -25(%ebp), %eax         #  14:     return t6
    jmp     l_f0_exit              
...
f1:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 89 of <array 15 of <array 15 of <array 79 of <array 17 of <bool>>>>>>> %ebp+8 ]
    ...
    # function body
    movl    $13143, %eax            #   0:     div    t3 <- 13143, 54547
    movl    $54547, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -16(%ebp)        
...
l_f1_2_while_cond:
    ...
    movb    %al, -17(%ebp)         
    movzbl  -17(%ebp), %eax         #   4:     if     t4 = 1 goto 3_while_body
    movl    $1, %ebx               
    cmpl    %ebx, %eax             
    je      l_f1_3_while_body      
l_f1_3_while_body:
    jmp     l_f1_2_while_cond       #   6:     goto   2_while_cond
    movl    $71214, %eax            #   7:     add    t5 <- 71214, 44127
    movl    $44127, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   8:     add    t6 <- t5, 18429
    movl    $18429, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   9:     return t6
    jmp     l_f1_exit              
