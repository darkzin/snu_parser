...
f0:
    ...
    #      8(%ebp)   4  [ %v1       <ptr(4) to <array 7 of <array 8 of <array 1 of <array 5 of <array 8 of <int>>>>>>> %ebp+8 ]
...
l_f0_1_if_true:
    movl    $97, %eax               #   4:     if     97 # 99 goto 7_if_true
    movl    $99, %ebx              
    cmpl    %ebx, %eax             
    jne     l_f0_7_if_true         
...
l_f0_8_if_false:
l_f0_6:
    movl    $18583, %eax            #  10:     if     18583 > 24627 goto 11_if_true
    movl    $24627, %ebx           
    cmpl    %ebx, %eax             
    jg      l_f0_11_if_true        
...
l_f0_0:
    ...
    movb    %al, -13(%ebp)         
    movzbl  -13(%ebp), %eax         #  21:     assign v2 <- t0
    movb    %al, -15(%ebp)         
...
f1:
    ...
    #     12(%ebp)   4  [ %v2       <ptr(4) to <array 5 of <array 6 of <array 8 of <array 7 of <array 9 of <bool>>>>>>> %ebp+12 ]
    ...
    jmp     l_f1_exit              
    jmp     l_f1_exit              
    movl    $60488, %eax            #   2:     assign v5 <- 60488
    movl    %eax, -16(%ebp)        
...
f2:
    ...
    movb    %al, -13(%ebp)         
    movl    $93873, %eax            #   1:     assign v3 <- 93873
    movl    %eax, -24(%ebp)        
