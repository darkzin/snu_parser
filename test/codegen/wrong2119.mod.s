...
f0:
    # stack offsets:
    #      8(%ebp)   4  [ %v1       <ptr(4) to <array 12 of <array 37 of <array 18 of <array 62 of <array 24 of <bool>>>>>>> %ebp+8 ]
    #     12(%ebp)   1  [ %v2       <bool> %ebp+12 ]
    #     16(%ebp)   4  [ %v3       <ptr(4) to <array 87 of <array 4 of <array 61 of <array 88 of <array 14 of <bool>>>>>>> %ebp+16 ]
...
f1:
    ...
    #      8(%ebp)   4  [ %v1       <ptr(4) to <array 31 of <array 43 of <array 96 of <array 48 of <array 27 of <bool>>>>>>> %ebp+8 ]
...
f2:
    ...
    #      8(%ebp)   4  [ %v1       <ptr(4) to <array 1 of <array 56 of <array 99 of <array 1 of <array 4 of <char>>>>>>> %ebp+8 ]
    ...
    addl    $8, %esp               
    movl    %eax, -72(%ebp)        
    movl    $35162, %eax            #   4:     mul    t4 <- 35162, t3
    movl    -72(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -76(%ebp)        
    movl    -76(%ebp), %eax         #   5:     add    t5 <- t4, 2686
    movl    $2686, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -80(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -88(%ebp)        
    movl    -88(%ebp), %eax         #  10:     add    t8 <- t7, 86235
    movl    $86235, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -92(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #  15:     add    t11 <- t10, 99104
    movl    $99104, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #  20:     add    t14 <- t13, 9667
    movl    $9667, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
    ...
    movl    -48(%ebp), %edi        
    movb    %al, (%edi)            
    call    dummyBOOLfunc           #  27:     call   t19 <- dummyBOOLfunc
    movb    %al, -49(%ebp)         
    movl    $44509, %eax            #  28:     sub    t20 <- 44509, 43186
    movl    $43186, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -56(%ebp)        
    movl    -56(%ebp), %eax         #  29:     add    t21 <- t20, 59311
    movl    $59311, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -60(%ebp)        
    movl    -60(%ebp), %eax         #  30:     sub    t22 <- t21, 42858
    movl    $42858, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -64(%ebp)        
    movl    -64(%ebp), %eax         #  31:     add    t23 <- t22, 76375
    movl    $76375, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -68(%ebp)        
    movl    -68(%ebp), %eax         #  32:     assign v3 <- t23
    movl    %eax, -104(%ebp)       
...
main:
    ...
    # function body
    jmp     l_test_exit            
    movl    $57489, %eax            #   1:     add    t0 <- 57489, 3178
    movl    $3178, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    $82691, %eax            #   2:     if     82691 # t0 goto 2
    movl    -16(%ebp), %ebx        
    cmpl    %ebx, %eax             
    jne     l_test_2               
