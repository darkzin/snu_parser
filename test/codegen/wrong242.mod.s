...
f0:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 3 of <array 3 of <array 1 of <array 2 of <array 4 of <bool>>>>>>> %ebp+12 ]
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 8 of <array 5 of <array 6 of <array 5 of <array 3 of <char>>>>>>> %ebp+16 ]
    #     20(%ebp)   4  [ %v3       <ptr(4) to <array 4 of <array 6 of <array 9 of <array 4 of <array 1 of <char>>>>>>> %ebp+20 ]
    ...
    movb    %al, -13(%ebp)         
    movl    $32377, %eax            #   1:     sub    t1 <- 32377, 62441
    movl    $62441, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     sub    t2 <- t1, 26395
    movl    $26395, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   3:     assign v4 <- t2
    movl    %eax, -28(%ebp)        
    jmp     l_f0_exit              
...
f1:
    ...
    movb    %al, -13(%ebp)         
    movl    $3820, %eax             #   1:     mul    t1 <- 3820, 85868
    movl    $85868, %ebx           
    imull   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    $95159, %eax            #   2:     if     95159 < t1 goto 2_if_true
    movl    -20(%ebp), %ebx        
    cmpl    %ebx, %eax             
    jl      l_f1_2_if_true         
...
l_f1_6_while_cond:
    jmp     l_f1_5                  #   9:     goto   5
l_f1_9_while_cond:
    movl    $97, %eax               #  11:     if     97 # 97 goto 10_while_body
    movl    $97, %ebx              
    cmpl    %ebx, %eax             
