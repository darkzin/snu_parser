...
f0:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 5 of <array 1 of <array 5 of <array 8 of <array 6 of <bool>>>>>>> %ebp+8 ]
...
l_f0_7:
    ...
    movb    %al, -14(%ebp)         
l_f0_8:
    movzbl  -14(%ebp), %eax         #  15:     return t1
    jmp     l_f0_exit              
    call    dummyBOOLfunc           #  16:     call   t2 <- dummyBOOLfunc
    movb    %al, -15(%ebp)         
    movzbl  -15(%ebp), %eax         #  17:     return t2
    jmp     l_f0_exit              
...
f1:
    # stack offsets:
    #    -13(%ebp)   1  [ $t0       <bool> %ebp-13 ]
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 10 of <array 8 of <array 1 of <array 6 of <array 3 of <int>>>>>>> %ebp+8 ]
...
l_f1_3_while_cond:
    ...
    jmp     l_f1_2                  #   4:     goto   2
l_f1_4_while_body:
    movl    $18062, %eax            #   6:     assign v2 <- 18062
    movl    %eax, -20(%ebp)        
...
f2:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 10 of <array 8 of <array 9 of <array 8 of <array 8 of <char>>>>>>> %ebp+8 ]
