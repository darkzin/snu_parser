...
f0:
    ...
    #      8(%ebp)   4  [ %v1       <ptr(4) to <array 10 of <array 4 of <array 9 of <array 10 of <array 7 of <char>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v2       <ptr(4) to <array 6 of <array 10 of <array 4 of <array 5 of <array 4 of <int>>>>>>> %ebp+12 ]
    ...
    movl    %eax, -16(%ebp)        
    jmp     l_f0_exit              
    movl    $79157, %eax            #   2:     sub    t2 <- 79157, 25788
    movl    $25788, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   3:     add    t3 <- t2, 82811
    movl    $82811, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   4:     add    t4 <- t3, 20701
    movl    $20701, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   5:     assign v3 <- t4
    movl    %eax, -32(%ebp)        
...
l_f1_1:
    ...
    movb    %al, -14(%ebp)         
    movzbl  -14(%ebp), %eax         #   8:     assign v1 <- t2
    movb    %al, -15(%ebp)         
...
f2:
    ...
    #     12(%ebp)   4  [ %v2       <ptr(4) to <array 3 of <array 2 of <array 2 of <array 3 of <array 4 of <char>>>>>>> %ebp+12 ]
...
main:
    ...
    # function body
    movl    $67368, %eax            #   0:     if     67368 = 14061 goto 1
    movl    $14061, %ebx           
    cmpl    %ebx, %eax             
    je      l_test_1               
...
l_test_22_while_cond:
    movl    $100, %eax              #  23:     if     100 <= 99 goto 23_while_body
    movl    $99, %ebx              
    cmpl    %ebx, %eax             
