...
f0:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 4 of <array 34 of <array 51 of <array 35 of <array 92 of <int>>>>>>> %ebp+8 ]
...
l_f0_0:
    ...
    movb    %al, -14(%ebp)         
    movzbl  -14(%ebp), %eax         #  10:     if     t2 <= 98 goto 7_if_true
    movl    $98, %ebx              
    cmpl    %ebx, %eax             
    jle     l_f0_7_if_true         
...
f2:
    ...
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 82 of <array 28 of <array 76 of <array 23 of <array 100 of <char>>>>>>> %ebp+16 ]
    ...
    movb    %al, -30(%ebp)         
    movl    $54224, %eax            #   1:     sub    t1 <- 54224, 69716
    movl    $69716, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   2:     sub    t2 <- t1, 61219
    movl    $61219, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   3:     add    t3 <- t2, 85785
    movl    $85785, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   4:     add    t4 <- t3, 98323
    movl    $98323, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   5:     if     t4 < 27533 goto 2
    movl    $27533, %ebx           
    cmpl    %ebx, %eax             
    jl      l_f2_2                 
    jmp     l_f2_3                  #   6:     goto   3
...
l_f2_3:
    ...
    movb    %al, -29(%ebp)         
l_f2_4:
    movzbl  -29(%ebp), %eax         #  13:     assign v1 <- t5
    movb    %al, 12(%ebp)          
...
main:
    ...
    movl    %eax, -16(%ebp)        
    movl    $13969, %eax            #   1:     assign v0 <- 13969
    movl    %eax, v0               
    jmp     l_test_exit            
