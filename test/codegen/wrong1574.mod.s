...
f0:
    ...
    movl    %eax, -16(%ebp)        
    movl    $92338, %eax            #   1:     mul    t5 <- 92338, t4
    movl    -16(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     return t5
    jmp     l_f0_exit              
    movl    $33819, %eax            #   3:     sub    t6 <- 33819, 99012
    movl    $99012, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    ...
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   6:     add    t8 <- t7, 62269
    movl    $62269, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
...
f2:
    ...
    #      8(%ebp)   4  [ %v1       <ptr(4) to <array 88 of <array 31 of <array 94 of <array 55 of <array 7 of <int>>>>>>> %ebp+8 ]
    ...
    movb    %al, -61(%ebp)         
    movl    $96790, %eax            #   1:     sub    t5 <- 96790, 72351
    movl    $72351, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -68(%ebp)        
    ...
    addl    $8, %esp               
    movl    %eax, -72(%ebp)        
    movl    $82060, %eax            #   5:     mul    t7 <- 82060, t6
    movl    -72(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -76(%ebp)        
    movl    -76(%ebp), %eax         #   6:     add    t8 <- t7, 32996
    movl    $32996, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -80(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #  11:     add    t11 <- t10, 77850
    movl    $77850, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #  16:     add    t14 <- t13, 35458
    movl    $35458, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
    ...
    imull   %ebx                   
    movl    %eax, -40(%ebp)        
    movl    -40(%ebp), %eax         #  21:     add    t17 <- t16, 46157
    movl    $46157, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -44(%ebp)        
    ...
    movl    %eax, (%edi)           
l_f2_3_while_cond:
    jmp     l_f2_4_while_body       #  29:     goto   4_while_body
    jmp     l_f2_4_while_body       #  30:     goto   4_while_body
