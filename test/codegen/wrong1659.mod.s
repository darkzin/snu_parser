...
f0:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 30 of <array 34 of <array 67 of <array 42 of <array 66 of <bool>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 1 of <array 95 of <array 31 of <array 79 of <array 78 of <bool>>>>>>> %ebp+12 ]
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 83 of <array 54 of <array 19 of <array 44 of <array 52 of <bool>>>>>>> %ebp+16 ]
    ...
    movl    $15404, %eax            #   2:     div    t4 <- 15404, 42357
    movl    $42357, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    $56617, %eax            #   3:     add    t5 <- 56617, t4
    movl    -20(%ebp), %ebx        
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
...
f1:
    ...
    movb    %al, 12(%ebp)          
    movl    $80314, %eax            #   1:     add    t3 <- 80314, 500
    movl    $500, %ebx             
    addl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   2:     if     t3 # 40762 goto 2_if_true
    movl    $40762, %ebx           
    cmpl    %ebx, %eax             
    jne     l_f1_2_if_true         
...
l_test_2_while_cond:
    ...
    movb    %al, -13(%ebp)         
    movzbl  -13(%ebp), %eax         #   3:     if     t0 = 1 goto 4
    movl    $1, %ebx               
    cmpl    %ebx, %eax             
    je      l_test_4               
