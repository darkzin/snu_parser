...
f0:
    ...
    # function body
    movl    $73371, %eax            #   0:     assign v0 <- 73371
    movl    %eax, -20(%ebp)        
...
l_f0_3_while_cond:
    ...
    movb    %al, -14(%ebp)         
    movzbl  -14(%ebp), %eax         #   4:     if     t3 >= 97 goto 4_while_body
    movl    $97, %ebx              
    cmpl    %ebx, %eax             
...
f1:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 13 of <array 46 of <array 47 of <array 31 of <array 72 of <char>>>>>>> %ebp+12 ]
...
l_f1_6_while_cond:
    ...
    movb    %al, -14(%ebp)         
    movzbl  -14(%ebp), %eax         #  11:     if     t3 # 98 goto 7_while_body
    movl    $98, %ebx              
    cmpl    %ebx, %eax             
...
l_f1_5:
    ...
    movb    %al, -15(%ebp)         
    movzbl  -15(%ebp), %eax         #  17:     return t4
    jmp     l_f1_exit              
...
f2:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 47 of <array 21 of <array 97 of <array 71 of <array 39 of <bool>>>>>>> %ebp+8 ]
...
l_f2_12_if_false:
l_f2_10:
    movl    $67534, %eax            #  17:     return 67534
    jmp     l_f2_exit              
