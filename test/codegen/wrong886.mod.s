...
f0:
    ...
    #     16(%ebp)   4  [ %v3       <ptr(4) to <array 10 of <array 4 of <array 7 of <array 7 of <array 9 of <bool>>>>>>> %ebp+16 ]
    ...
    # function body
    movl    $75878, %eax            #   0:     assign v4 <- 75878
    movl    %eax, -20(%ebp)        
...
f1:
    ...
    # function body
    movl    $29807, %eax            #   0:     sub    t3 <- 29807, 80817
    movl    $80817, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     sub    t4 <- t3, 23176
    movl    $23176, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     add    t5 <- t4, 11371
    movl    $11371, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    ...
    jmp     l_f1_exit              
l_f1_2_while_cond:
    movl    $48032, %eax            #   5:     if     48032 < 83903 goto 3_while_body
    movl    $83903, %ebx           
    cmpl    %ebx, %eax             
...
l_f1_7_if_false:
l_f1_5:
    movl    $64195, %eax            #  12:     assign v1 <- 64195
    movl    %eax, -32(%ebp)        
...
main:
    ...
    movb    %al, -13(%ebp)         
    movl    $63117, %eax            #   1:     assign v0 <- 63117
    movl    %eax, v0               
l_test_3_while_cond:
...
l_test_2:
    movl    $37040, %eax            #   7:     div    t1 <- 37040, 10795
    movl    $10795, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   8:     div    t2 <- t1, 10828
    movl    $10828, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -24(%ebp)        
