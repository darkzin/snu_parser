...
f1:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 5 of <array 10 of <array 3 of <array 4 of <array 1 of <int>>>>>>> %ebp+8 ]
...
l_test_2_while_cond:
    ...
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   3:     add    t1 <- t0, 99894
    movl    $99894, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   4:     if     t1 >= 44260 goto 3_while_body
    movl    $44260, %ebx           
    cmpl    %ebx, %eax             
