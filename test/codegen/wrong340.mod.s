...
f1:
    ...
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     mul    t3 <- t2, 15375
    movl    $15375, %ebx           
    imull   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     div    t4 <- t3, 43955
    movl    $43955, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   3:     mul    t5 <- t4, 49341
    movl    $49341, %ebx           
    imull   %ebx                   
    movl    %eax, -28(%ebp)        
    ...
    movb    %al, -29(%ebp)         
    movl    $28160, %eax            #   6:     mul    t7 <- 28160, 24481
    movl    $24481, %ebx           
    imull   %ebx                   
    movl    %eax, -36(%ebp)        
    movl    -36(%ebp), %eax         #   7:     div    t8 <- t7, 502
    movl    $502, %ebx             
    cdq                            
    idivl   %ebx                   
    movl    %eax, -40(%ebp)        
    movl    -40(%ebp), %eax         #   8:     if     t8 = 60847 goto 3_if_true
    movl    $60847, %ebx           
    cmpl    %ebx, %eax             
    je      l_f1_3_if_true         
...
main:
    ...
    movb    %al, -14(%ebp)         
    movl    $11872, %eax            #   2:     assign v0 <- 11872
    movl    %eax, v0               
