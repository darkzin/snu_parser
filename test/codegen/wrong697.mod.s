...
f2:
    ...
    # function body
    movl    $69815, %eax            #   0:     add    t1 <- 69815, 79351
    movl    $79351, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     sub    t2 <- t1, 98282
    movl    $98282, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     sub    t3 <- t2, 18721
    movl    $18721, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   3:     add    t4 <- t3, 68486
    movl    $68486, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
...
l_f2_2_while_cond:
    ...
    movb    %al, -29(%ebp)         
    movl    $98, %eax               #   7:     if     98 <= t5 goto 3_while_body
    movzbl  -29(%ebp), %ebx        
    cmpl    %ebx, %eax             
...
l_f2_3_while_body:
l_f2_6_while_cond:
    movl    $82512, %eax            #  11:     if     82512 >= 57310 goto 7_while_body
    movl    $57310, %ebx           
    cmpl    %ebx, %eax             
...
l_f2_1:
    movl    $75246, %eax            #  18:     sub    t6 <- 75246, 88197
    movl    $88197, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -36(%ebp)        
    movl    -36(%ebp), %eax         #  19:     add    t7 <- t6, 9754
    movl    $9754, %ebx            
    addl    %ebx, %eax             
    movl    %eax, -40(%ebp)        
    movl    -40(%ebp), %eax         #  20:     sub    t8 <- t7, 83151
    movl    $83151, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -44(%ebp)        
    movl    -44(%ebp), %eax         #  21:     param  0 <- t8
    pushl   %eax                   
