...
f0:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 75 of <array 52 of <array 23 of <array 83 of <array 42 of <char>>>>>>> %ebp+8 ]
...
f1:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 59 of <array 38 of <array 67 of <array 58 of <array 11 of <int>>>>>>> %ebp+12 ]
    ...
    # function body
    movl    $44242, %eax            #   0:     mul    t0 <- 44242, 4167
    movl    $4167, %ebx            
    imull   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     mul    t1 <- t0, 17569
    movl    $17569, %ebx           
    imull   %ebx                   
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   2:     sub    t2 <- t1, 69245
    movl    $69245, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
...
f2:
    ...
    #    -16(%ebp)   4  [ $t0       <int> %ebp-16 ]
    #    -20(%ebp)   4  [ $t1       <int> %ebp-20 ]
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 43 of <array 48 of <array 40 of <array 38 of <array 54 of <int>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <int> %ebp+12 ]
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 36 of <array 26 of <array 95 of <array 89 of <array 97 of <char>>>>>>> %ebp+16 ]
    #     20(%ebp)   4  [ %v3       <ptr(4) to <array 19 of <array 82 of <array 39 of <array 80 of <array 100 of <char>>>>>>> %ebp+20 ]
    ...
    # function body
    movl    $59547, %eax            #   0:     div    t0 <- 59547, 4624
    movl    $4624, %ebx            
    cdq                            
    idivl   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     sub    t1 <- t0, 59321
    movl    $59321, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    ...
    addl    $4, %esp               
    movl    $97, %eax               #   4:     if     97 >= 98 goto 2_if_true
    movl    $98, %ebx              
    cmpl    %ebx, %eax             
    jge     l_f2_2_if_true         
...
l_f2_2_if_true:
    jmp     l_f2_exit              
l_f2_7_while_cond:
    movl    $98, %eax               #   9:     if     98 < 97 goto 8_while_body
    movl    $97, %ebx              
    cmpl    %ebx, %eax             
