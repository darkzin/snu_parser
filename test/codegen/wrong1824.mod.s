...
f0:
    ...
    # function body
    movl    $23999, %eax            #   0:     assign v2 <- 23999
    movl    %eax, -16(%ebp)        
    jmp     l_f0_exit              
    jmp     l_f0_exit              
...
f2:
    ...
    pushl   %eax                   
    movl    $1, %eax                #   2:     param  0 <- 1
    pushl   %eax                   
    call    f0                      #   3:     call   f0
    addl    $8, %esp               
    movl    $82761, %eax            #   4:     add    t5 <- 82761, 29522
    movl    $29522, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   5:     assign v1 <- t5
    movl    %eax, 12(%ebp)         
...
main:
    ...
    # function body
    movl    $78584, %eax            #   0:     div    t0 <- 78584, 21791
    movl    $21791, %ebx           
    cdq                            
    idivl   %ebx                   
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     div    t1 <- t0, 3000
    movl    $3000, %ebx            
    cdq                            
    idivl   %ebx                   
    movl    %eax, -20(%ebp)        
...
l_test_4:
    ...
    movb    %al, v1                
    movl    $43650, %eax            #  12:     mul    t3 <- 43650, 94475
    movl    $94475, %ebx           
    imull   %ebx                   
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #  13:     assign v0 <- t3
    movl    %eax, v0               
