...
l_f0_1_while_cond:
    jmp     l_f0_0                  #   1:     goto   0
l_f0_4_while_cond:
    movl    $28218, %eax            #   3:     if     28218 <= 69795 goto 5_while_body
    movl    $69795, %ebx           
    cmpl    %ebx, %eax             
...
f1:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 80 of <array 52 of <array 28 of <array 52 of <array 19 of <bool>>>>>>> %ebp+8 ]
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 77 of <array 71 of <array 66 of <array 99 of <array 18 of <char>>>>>>> %ebp+12 ]
    ...
    addl    $8, %esp               
    movl    %eax, -60(%ebp)        
    movl    $95619, %eax            #   4:     mul    t3 <- 95619, t2
    movl    -60(%ebp), %ebx        
    imull   %ebx                   
    movl    %eax, -64(%ebp)        
...
f2:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 50 of <array 92 of <array 11 of <array 83 of <array 87 of <int>>>>>>> %ebp+12 ]
    ...
    movb    %al, 16(%ebp)          
    movl    $58401, %eax            #   2:     add    t1 <- 58401, 70511
    movl    $70511, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   3:     if     t1 # 89640 goto 3_if_true
    movl    $89640, %ebx           
    cmpl    %ebx, %eax             
    jne     l_f2_3_if_true         
...
main:
    ...
    movl    $98, %eax               #   2:     if     98 < 97 goto 1_if_true
    movl    $97, %ebx              
    cmpl    %ebx, %eax             
    jl      l_test_1_if_true       
...
l_test_0:
    ...
    movb    %al, -13(%ebp)         
    movzbl  -13(%ebp), %eax         #   9:     param  0 <- t0
    pushl   %eax                   
...
l_test_8_while_cond:
    ...
    movl    $49103, %eax            #  14:     assign v1 <- 49103
    movl    %eax, v1               
