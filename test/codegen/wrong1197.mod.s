...
f0:
    ...
    # function body
    movl    $4054, %eax             #   0:     assign v0 <- 4054
    movl    %eax, -24(%ebp)        
    ...
    movb    %al, -17(%ebp)         
    movzbl  -17(%ebp), %eax         #   5:     assign v1 <- t3
    movb    %al, -25(%ebp)         
...
f1:
    ...
    #     12(%ebp)   4  [ %v1       <ptr(4) to <array 10 of <array 50 of <array 56 of <array 66 of <array 76 of <int>>>>>>> %ebp+12 ]
    #     16(%ebp)   4  [ %v2       <ptr(4) to <array 98 of <array 23 of <array 43 of <array 69 of <array 11 of <char>>>>>>> %ebp+16 ]
    ...
    movb    %al, -65(%ebp)         
    movl    $71943, %eax            #   2:     mul    t4 <- 71943, 93640
    movl    $93640, %ebx           
    imull   %ebx                   
    movl    %eax, -72(%ebp)        
...
f2:
    ...
    # function body
    movl    $95386, %eax            #   0:     sub    t2 <- 95386, 39559
    movl    $39559, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #   1:     return t2
    jmp     l_f2_exit              
    movl    $25250, %eax            #   2:     param  0 <- 25250
    pushl   %eax                   
    call    WriteInt                #   3:     call   WriteInt
    addl    $4, %esp               
    movl    $95751, %eax            #   4:     sub    t3 <- 95751, 43331
    movl    $43331, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -20(%ebp)        
    movl    -20(%ebp), %eax         #   5:     add    t4 <- t3, 87431
    movl    $87431, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -24(%ebp)        
    movl    -24(%ebp), %eax         #   6:     add    t5 <- t4, 10155
    movl    $10155, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -28(%ebp)        
    movl    -28(%ebp), %eax         #   7:     sub    t6 <- t5, 73185
    movl    $73185, %ebx           
    subl    %ebx, %eax             
    movl    %eax, -32(%ebp)        
    movl    -32(%ebp), %eax         #   8:     add    t7 <- t6, 47963
    movl    $47963, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -36(%ebp)        
    movl    -36(%ebp), %eax         #   9:     add    t8 <- t7, 74164
    movl    $74164, %ebx           
    addl    %ebx, %eax             
    movl    %eax, -40(%ebp)        
    movl    -40(%ebp), %eax         #  10:     return t8
    jmp     l_f2_exit              
...
l_test_0:
l_test_5_while_cond:
    movl    $85189, %eax            #   7:     if     85189 >= 63432 goto 6_while_body
    movl    $63432, %ebx           
    cmpl    %ebx, %eax             
...
l_test_9_while_cond:
    ...
    movl    %eax, -16(%ebp)        
    movl    -16(%ebp), %eax         #  12:     if     t0 <= 33800 goto 10_while_body
    movl    $33800, %ebx           
    cmpl    %ebx, %eax             
