...
f0:
    ...
    # function body
    jmp     l_f0_exit              
    movl    $3073, %eax             #   1:     assign v0 <- 3073
    movl    %eax, -20(%ebp)        
l_f0_3_while_cond:
    call    dummyBOOLfunc           #   3:     call   t2 <- dummyBOOLfunc
    movb    %al, -13(%ebp)         
    movzbl  -13(%ebp), %eax         #   4:     if     t2 = 1 goto 4_while_body
    movl    $1, %ebx               
    cmpl    %ebx, %eax             
...
f1:
    ...
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 23 of <array 37 of <array 76 of <array 84 of <array 73 of <char>>>>>>> %ebp+8 ]
...
f2:
    # stack offsets:
    #    -13(%ebp)   1  [ $t2       <bool> %ebp-13 ]
    #      8(%ebp)   4  [ %v0       <ptr(4) to <array 33 of <array 88 of <array 40 of <array 2 of <array 93 of <int>>>>>>> %ebp+8 ]
